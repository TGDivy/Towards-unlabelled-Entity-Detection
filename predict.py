...
class Predict():
    def __init__(self, args):
        ...
        self.tokenizer = RobertaTokenizer.from_pretrained(args.loadmodel_name_path, do_lower_case=True)
    ...
    def load_input(self, sentence):
        ...
        final_input = {
            "inputs":(torch.tensor(input_id).view(1, -1), torch.tensor(input_mask).view(1, -1)),
    ...
    def to_device(self, batch):
        batch["inputs"] = tuple(input_tensor.to(self.device) for input_tensor in batch["inputs"])
