...
#     from .test import evaluate as test
...
def train(args, tokenizer, model):
    ...
    if args.local_rank in [-1, 0]:
        log_dir = os.path.join("Outputs/Runs/Final_Run/", args.exp_name) if args.exp_name else None
...
#         args.output_dir = log_dir
    ...
    train_iterator = trange(
        0+1, int(args.num_train_epochs)+1, desc="Epoch", disable=args.local_rank not in [-1, 0]
    )
